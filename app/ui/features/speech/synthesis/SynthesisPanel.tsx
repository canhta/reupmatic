...
export function SynthesisPanel() {
  ...
  return (
    <InspectorPanelSection title={t('synthesisTitle')}>
      ...
      {/* Status and its actions only while something needs the user's attention:
          a clear "nothing to do" line for the ready state would be reviewer copy.
          The re-check action sits in the same action row as Set up across Voice,
