...
interface Active {
  ...
  /** The synthesis architecture that produced this job, captured at start so the review consults
   *  the capability this job actually used even if the configured model changes later. */
  engine: string;
}
