...
export function ChannelsWorkspace() {
  ...
  // Native Channels-menu "New Post…" first switches to the Posts
  // tab the same way clicking it does; PostBrowser's own registration (below)
  // then opens the create form the same way its own button does.
