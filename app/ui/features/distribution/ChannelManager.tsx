...
// Table's data-driven plugins (sort/filter/pagination) require T extends
// Record<string, unknown>; Channel is a plain named type with no index
// signature, so it needs this wrapper per Table's own documented pattern.
...
export function ChannelManager({
  ...
  // Not memoized: openChannel/onPosts close over per-render state (form,
  // setEditing), and re-deriving five column defs each render is cheap.
            ...
            endContent={
              <div className="action-row">
                ...
                <Button
                  ...
                  // `tooltip` keeps this focusable via aria-disabled instead
                  // of the native attribute while the catalog snapshot is
                  // still loading (see LibraryDetails.tsx for the pattern).
