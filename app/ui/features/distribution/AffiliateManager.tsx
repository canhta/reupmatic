...
// AffiliateLink is a plain named type with no index signature, so it needs
...
export function AffiliateManager({ onPosts }: { onPosts(id: string): void }) {
  ...
  // Not memoized: openLink/onPosts close over per-render state, and
  // re-deriving three column defs each render is cheap.
