...
/**
 * Label management's home now that labels are a Library filter facet, not a peer tab
 * (ticket 14). A dialog keeps create/rename/archive reachable without giving the label
 * catalogue a navigation destination every reference refuses to give it.
 */
