...
/**
 * The Replace half of the cue list's one ⌕ bar: find is the search field
 * above it, so only replace/scope stay always visible here; regex and case
 * sensitivity are a collapsed advanced section.
 */
