...
/**
 * Drives the cue list's own ⌕ find bar: the same query text the list
 * already filters by becomes the rule's "find" term once Replace is open,
 * previewed off the main thread (`text-rule.worker`) before it ever touches
 * the document.
 */
