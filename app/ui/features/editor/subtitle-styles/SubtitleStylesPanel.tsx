...
/**
 * The inspector's Style tab (the default tab): the track default applies
 * everywhere, with "Customize this cue" as the opt-in for a per-cue
 * override on the currently selected cue (Resolve's "Customize Caption"
 * model).
 */
export function SubtitleStylesPanel() {
  ...
  return (
    // No visible heading: the "Style" tab already labels this panel
    // (UI-T04 — a pane must not repeat its container's own title).
    <Section
      variant="transparent"
      padding={0}
