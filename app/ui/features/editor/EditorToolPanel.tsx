...
/**
 * The tool panel a rail item opens beside the rail. It is one stable element
 * across the wide/narrow breakpoint (EditorRegions.tsx renders the same tree
 * either way) so the open item and its panel state — a synthesis review draft,
 * a soundtrack pick — survive the 1200px crossing the old inspector remounted on.
 */
