...
// react-timeline-editor's own stylesheet is required or every track/action renders invisible.
...
export function TimelineStrip({ wave }: { wave: (node: HTMLDivElement | null) => void }) {
  ...
  useEffect(() => {
    function onKeydown(event: KeyboardEvent) {
      ...
      // Ignore V while typing or with a modifier so it never eats cue text.
      if (
