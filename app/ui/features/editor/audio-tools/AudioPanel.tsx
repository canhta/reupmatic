...
/**
 * The Audio tool panel: the viewer's audio settings that are not narration —
 * Source (original audio gain/mute) and Music (the soundtrack mix). The voice
 * tools moved to their own Voice item when D-63 split the old Audio tab.
 */
