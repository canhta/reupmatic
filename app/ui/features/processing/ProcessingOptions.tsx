...
export function ProcessingOptions({
  ...
  return (
    ...
    >
      {/* Astryx Stack owns the section spacing: the app's own layered grid rule
          lost to Astryx's unlayered Section styling, which collapsed the gap
          between the Reset action and the next section trigger. */}
