...
export function WorkspaceStatusBar({
  ...
  const queueStatus = queue.error
    ...
    : live > 0
      ...
      : t('queueIdle');
  // The download aggregate is read from the one run snapshot; it never owns a queue of its own.
  // Finished-and-reused work still reports a summary so a run is legible after it settles.
