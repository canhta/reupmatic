...
export function App() {
  ...
  useEffect(() => {
    ...
    void window.reupmatic.dirty(
      editorDirty || batchDirty || folderDirty || catalogDirty,
      i18n.language,
    );
  }, [editorDirty, batchDirty, folderDirty, catalogDirty, i18n.language]);

  const descriptions = {
    sources: 'libraryIntro',
    settings: 'settingsIntro',
    automation: 'automationIntro',
    channels: 'channelsIntro',
  } as const;
  return (
        ...
        >
          <div className="workspace-content">
            ...
            <div hidden={area !== 'automation'}>
              <AutomationWorkspace queue={queue} onFolderDirty={setFolderDirty} />
            </div>
