...
// Docked column at wide widths, overlay drawer below 1200px; the switch is CSS-only.
  ...
  return (
    <aside
      ...
      onKeyDown={(event: KeyboardEvent) => {
        ...
        // A confirmation <dialog> opened inside this keydown is cancelled by Chromium in the same tick.
