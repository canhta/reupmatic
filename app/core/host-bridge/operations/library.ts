...
export const libraryOperations = {
  ...
  // "Open in Editor" from the Library while a project is already open adds the
  // video to that project's media instead of replacing it (D-63); the resolved
  // original becomes a stored Project media row, the same shape the Add… dialog
  // produces.
