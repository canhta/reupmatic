...
export interface LayerMetadata {
  ...
  edited: boolean;
  stale: boolean;
  /** Exactly one layer is visible at a time. */
  visible: boolean;
}
...
export function parseTextLayers(value: unknown): TextLayers {
  ...
  // Only one layer may be visible; fail where read, not silently pick one.
...
/** The one visible layer; `null` when every layer is hidden. */
