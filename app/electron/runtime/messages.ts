...
// One small localized message module, composed by the entry point (main.ts) and the native menu
// (menu.ts) — neither grows its own inline `lang === 'vi' ? … : …` ternaries (NAV-L10N).
