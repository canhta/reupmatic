...
import { parseSoundtrack, type Soundtrack } from '../../../../core/editing/soundtrack.js';
import type { IpcWire } from '../../../runtime/ipc.js';
import { audioFilters, type MediaRegistry } from '../../media/registry.js';

export function installAudio(host: {
  wire: IpcWire;
  media: MediaRegistry;
  ...
  host.wire('audio-preview', (input) => host.media.authorizeSoundtrack(input));
}
