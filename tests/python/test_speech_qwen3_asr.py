"""Controlled doubles; call-shape and plumbing only."""
...
# Qwen3-ASR transcribe() returns one (language, text) pair, no timing or segments.
...
class SpeechQwen3ASRTests(unittest.TestCase):
    ...
    def test_cancel_reaps_real_child_cleans_audio_and_unblocks_shared_queue(self):
        # Qwen3-ASR transcribe() is one blocking call; the pid file signals genuine busy.
