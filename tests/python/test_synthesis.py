...
from synthesis_fixture import bundle, nano_bundle, params
...
class NanoSynthesisModelTests(unittest.TestCase):
    """The second architecture: a different bundle layout, voice schema and duration capability."""
...
class MaterialiseVoicesTests(unittest.TestCase):
    """A downloaded bundle's `voices.json` is derived from the installed SDK, not downloaded."""
