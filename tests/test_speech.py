...
class SpeechTests(unittest.TestCase):
    ...
    def test_status_does_not_hash_or_load_model_and_does_not_claim_verified(self):
        with patch(
            "speech.recognition.models.file_hash", side_effect=AssertionError("unexpected hash")
        ):
    ...
    def test_configuration_is_explicit_atomic_and_does_not_install_anything(self):
        ...
        host = SimpleNamespace(
            workspace=workspace, speech_models=SpeechRegistry(target), cancelled=lambda _: None
        )
