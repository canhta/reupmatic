...
import { parseEditing, resolveEditWindow, retimeCues } from '../dist-core/editing/edit-recipe.js';
...
test('editing-only recipes need no model and isolate the caller snapshot', () => {
  const input = { version: 1, editing: { trim, speed: 2, audio: { muted: false, gain_db: -3 } } };
